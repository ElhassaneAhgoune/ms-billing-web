...
export const NavigationItems: NavigationItem[] = [
    ...
    children: [
      {
        ...
        description: 'Invoice management overview and statistics'
      }
    ]
  },
  {
  ...
  {
    id: 'actions-of-users',
    title: 'Actions Of Users',
    type: 'group',
    icon: 'icon-navigation',
    groupClasses: 'nav-group-users',
    children: [
      {
        ...
        icon: 'table',
        breadcrumbs: false,
        description: 'Actions Follow Up details',
        tooltipTitle: 'Actions Follow Up',
