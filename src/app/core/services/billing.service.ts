...
export class BillingService {
   ...
   */
  getVisaChargesSummary(params: VisaInvoiceQueryParams = {}): Observable<SummaryVisaResponseDto[]> {
   ...
   */
  getVisaServiceBreakdown(params: VisaInvoiceQueryParams = {}): Observable<ServiceBreakdownResponseDto[]> {
   ...
   */
  getMasterCardChargesSummary(params: MastercardInvoiceQueryParams = {}): Observable<SummaryResponseDto[]> {
   ...
   * Note: The API endpoint uses 'masterCard' (with capital 'C')
   */
  getMasterCardServiceBreakdown(params: MastercardInvoiceQueryParams = {}): Observable<ServiceBreakdownResponseDto[]> {
